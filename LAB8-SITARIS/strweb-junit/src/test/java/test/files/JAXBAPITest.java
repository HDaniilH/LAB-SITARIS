...
class JAXBAPITest {
    ...
    void jsonTest() {
        try {
            JAXBAPI.addFromJson("C:\\Users\\keerd\\IdeaProjects\\strweb-junit\\files\\in.json", getSession());
            JAXBAPI.dumpToJson("C:\\Users\\keerd\\IdeaProjects\\strweb-junit\\files\\out.json", getSession(), "400");
            JAXBAPI.executeXML("C:\\Users\\keerd\\IdeaProjects\\strweb-junit\\files\\5.xml", getSession());
        } catch (IOException | JAXBException e) {
            fail();
        }
    }
